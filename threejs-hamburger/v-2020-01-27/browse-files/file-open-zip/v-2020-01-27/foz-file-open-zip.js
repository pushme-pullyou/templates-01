...
<p>
	...
	time elapspsed ${ ( performance.now() - FOZ.timeStart ).toLocaleString() } ms
</p>
<hr>
`;
...
`;
	...
	FOZdivContent.innerHTML = `
<p>
	First thousand characters
</p>
<textarea style=height:30rem;width:100%;>${ FOZ.text.slice( 0, 1000 ) }</textarea>
`;
