...
THRT.onLoad = function ( event ) {

	console.log( 'thrt', event );
...
THRT.getMenu = function () {
	...
	<details>
		...
		<summary title="thrt-three-toggles-2020-01-21-01.js" >Display scene settings
		...
		<p  title="XYZ = RGB" >
			<label>
				<input type=checkbox onchange=THRT.toggleAxesHelper() checked> axes helper
			</label>
		</p>
...
THRT.toggleAxesHelper = function ( scale = THR.radius, visible = true ) {
